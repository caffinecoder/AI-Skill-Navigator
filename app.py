# Add this to your app.py file to serve static frontend files
...
def not_found(error):
    return jsonify({
        ...
        "available_endpoints": ["/", "/api/analyze", "/api/auth/verify", "/api/github/repos/<username>", "/api/github/user-repos"]
    }), 404
...
if __name__ == "__main__":
    ...
    print("   POST /api/analyze - AI analysis (requires auth)")
    print("   POST /api/auth/verify - Verify authentication token")
    print("   GET  /api/github/repos/<username> - Public GitHub repos")
    print("   GET  /api/github/user-repos - User's GitHub repos (Outbound Apps)")
